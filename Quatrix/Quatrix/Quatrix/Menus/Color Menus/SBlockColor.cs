...
namespace Quatrix
{
    class SBlockColor : ColorChooserType
    {
        public SBlock block;

        public SBlockColor(ContentManager content, string fileName)
            : base(content, "S-Block Color", "Block List", "Matura MT Script Capitals", "Highlight", 101, 30)
        {
            initialize();
        ...
        {
            setTitle("S-Block", content.Load<SpriteFont>("Matura Title"), Color.Red, new Vector2(15, 20));

            SlideType temp = new SlideType("Red", Font, Color.Red, new Vector2(25, 100), new Vector2(), "S-Block Color", 0, 255, 20, 95);
            ...
            temp = new SlideType("Blue", Font, Color.Red, new Vector2(25, 140), new Vector2(), "S-Block Color", 0, 255, 20, 135);
            ...
            temp = new SlideType("Green", Font, Color.Red, new Vector2(25, 180), new Vector2(), "S-Block Color", 0, 255, 20, 175);
