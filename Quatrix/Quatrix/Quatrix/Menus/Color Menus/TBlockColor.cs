...
namespace Quatrix
{
    class TBlockColor : ColorChooserType
    {
        public TBlock block;

        public TBlockColor(ContentManager content, string fileName)
            : base(content, "T-Block Color", "Block List", "Matura MT Script Capitals", "Highlight", 101, 30)
        {
            initialize();
