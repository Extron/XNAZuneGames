...
namespace Quatrix
{
    class SongsMenu : MediaLibraryMenuType
    {
        public SongsMenu(ContentManager content, string fileName)
            : base(content, "Songs", "Playlist Menu", "Matura MT Script Capitals", "Highlight", 201, 30, 7)
        {
            initialize();
        ...
        {
            setTitle("Songs", content.Load<SpriteFont>("Matura Title"), Color.Red, new Vector2(15, 20));
