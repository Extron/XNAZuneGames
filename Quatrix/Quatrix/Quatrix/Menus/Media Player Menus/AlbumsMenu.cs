...
namespace Quatrix
{
    class AlbumsMenu : MediaLibraryMenuType
    {
        public AlbumsMenu(ContentManager content, string fileName)
            : base(content, "Albums", "Playlist Menu", "Matura MT Script Capitals", "Highlight", 201, 30, 7)
        {
            initialize();
        ...
        {
            setTitle("Albums", content.Load<SpriteFont>("Matura Title"), Color.Red, new Vector2(15, 20));
