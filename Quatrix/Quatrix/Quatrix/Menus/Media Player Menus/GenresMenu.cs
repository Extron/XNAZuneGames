...
namespace Quatrix
{
    class GenresMenu : MediaLibraryMenuType
    {
        public GenresMenu(ContentManager content, string fileName)
            : base(content, "Genres", "Playlist Menu", "Matura MT Script Capitals", "Highlight", 201, 30, 7)
        {
            initialize();
        ...
        {
            setTitle("Genres", content.Load<SpriteFont>("Matura Title"), Color.Red, new Vector2(15, 20));
