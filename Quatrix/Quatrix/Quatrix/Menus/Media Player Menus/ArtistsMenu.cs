...
namespace Quatrix
{
    class ArtistsMenu : MediaLibraryMenuType
    {
        public ArtistsMenu(ContentManager content, string fileName)
            : base(content, "Artists", "Playlist Menu", "Matura MT Script Capitals", "Highlight", 201, 30, 7)
        {
            initialize();
        ...
        {
            setTitle("Artists", content.Load<SpriteFont>("Matura Title"), Color.Red, new Vector2(15, 20));
