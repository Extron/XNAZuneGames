...
namespace Snakez
{
    class Paused : MenuType
    {
        ...
        {
            TitleComponent title = new TitleComponent("Paused", "Lindsey", Color.Yellow, new Vector2(120, 100), TextAlignment.center);
        ...
        private void setOptions()
        {
            ...
            OptionType option = new OptionType("Resume", "LindseySmall", Color.Red, new Vector2(120, 140), OptionAction.previous, true, new Rectangle(120, 140, 120, 25), "Menus/Center Highlight");
            option.Alignment = TextAlignment.center;
            options.add(option);

            option = new OptionType("Options", "LindseySmall", Color.Red, new Vector2(120, 160), "Options", new Rectangle(120, 160, 120, 25), "Menus/Center Highlight");
            option.Alignment = TextAlignment.center;
            options.add(option);

            option = new OptionType("Quit", "LindseySmall", Color.Red, new Vector2(120, 180), OptionAction.endGame, true, new Rectangle(120, 180, 120, 25), "Menus/Center Highlight");
            option.Alignment = TextAlignment.center;
            options.add(option);
