...
namespace Reverb.Components.Titles
{
    public class TitleComponent : ComponentType, IMenuComponent
    {
        SpriteFont font;
        ...
        public TitleComponent(string fontAsset, string title, Vector2 titlePosition, Color textColor)
        {
            identifier = "Title";
